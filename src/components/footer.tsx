      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="space-y-4">
            ...
            <p className="text-white/70 text-sm leading-relaxed">
              Платформа для онлайн-консультаций со специалистами медицинских организаций.
          ...
          <div>
            {/*
              ...
              то, что можно сделать через платформу, а сами консультации проводят
              организации-партнёры. Заголовок «Услуги» на сайте платформы читается
              как «услуги оказываем мы» и опровергает разделение ответственности,
              на котором держится модель поручения.

              Формулировки пунктов согласованы с §2 оферты: «разбор» и «объяснение»,
              а не «второе мнение» или «расшифровка», которые описывают
              медицинскую помощь.
            */}
            ...
            <ul className="space-y-2 text-white/70 text-sm">
              ...
              <li>
                <Link href="/#categories" className="hover:text-teal-on-dark transition-colors">
                  Объяснение результатов анализов
                </Link>
              </li>
              <li>
                <Link href="/#categories" className="hover:text-teal-on-dark transition-colors">
                  Подготовка к очному приёму
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-6 pt-6 border-t border-white/15">
          <p className="text-white/55 text-xs leading-relaxed max-w-3xl text-pretty">
            Консультации в сервисе являются информационно-консультационными услугами и не
            являются медицинской помощью. Специалист не ставит диагноз, не назначает и не меняет
            лечение, не выписывает рецепты и не оформляет медицинские документы. Консультация не
            заменяет очный приём врача. При ухудшении состояния обратитесь в медицинскую
            организацию, при угрозе жизни — звоните 103 или 112.
          </p>
        </div>
