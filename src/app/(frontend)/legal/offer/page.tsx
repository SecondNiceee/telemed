...
export default async function OfferPage() {
  ...
  return (
    <LegalShell
      ...
      lead="Договор между сервисом и пользователем: доступ к платформе, запись на консультацию, оплата и возврат. Консультацию проводит специалист организации, которую вы выбираете; она носит информационный характер и не является медицинской помощью."
    >
      ...
      <section className="flex flex-col gap-3 border-t pt-8">
        ...
        <ul className="flex flex-col gap-2">
          ...
          <li className="text-pretty leading-relaxed text-muted-foreground">
            ...
            {' — кто именно проводит консультации и отвечает за данные о здоровье.'}
          </li>
        </ul>
      </section>
    </LegalShell>
